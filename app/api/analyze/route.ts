...
import { handleApiError, ApiError } from "../../../lib/error.ts";
import {rateLimiter} from "../../../lib/rateLimiters.ts";
import {API, PDF_PROCESSING} from "../../../lib/constants.ts";
...
export async function POST(request: NextRequest){
  try {
    ...
    const proceedText = text.substring(0, PDF_PROCESSING.MAX_TEXT_LENGTH)
          ...
          contents :[{
            parts:[{
              text:`
                    ...
                    ##Main Insights
                    Provide 2-3 well-crafted paragraphs that explain the key arguments or findings from the document.
                    ...
                    ## Critical Analysis
                    In 1-2 paragraphs , analyze the document's methodology, approach, or perspective.
